...
def _execution_platform_configure_impl(repository_ctx):
    ...
    repository_ctx.template(
        "BUILD",
        Label("@niantic//bzl/crosstool:execution-platform-configure.BUILD.tpl"),
    )
