...
cc_library(
    ...
    hdrs = VULKAN_HDRS,
    defines = select({
        "@niantic//bzl/conditions:windows": ["VK_USE_PLATFORM_WIN32_KHR"],
        # "IF_X11":  [ "VK_USE_PLATFORM_XCB_KHR" ],
        # "IF_WAYLAND":  [ "VK_USE_PLATFORM_WAYLAND_KHR" ],
        "@niantic//bzl/conditions:android": ["VK_USE_PLATFORM_ANDROID_KHR"],
        # "IF_FUSCHIA":  [ "VK_USE_PLATFORM_FUCHIA_KHR" ],
        "@niantic//bzl/conditions:apple": ["VK_USE_PLATFORM_METAL_EXT"],
