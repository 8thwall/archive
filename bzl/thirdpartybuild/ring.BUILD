...
cc_library(
    ...
    srcs = select({
        ...
        "@niantic//bzl/conditions:osx-x86_64": osx_universal_asm_srcs,
        "@niantic//bzl/conditions:osx-arm64": ios_asm_srcs,
        "@niantic//bzl/conditions:ios": ios_asm_srcs,
        "@niantic//bzl/conditions:android-arm64": android_arm64_asm_srcs,
