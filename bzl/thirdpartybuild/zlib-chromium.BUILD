...
cc_library(
    ...
    srcs = [
        ...
        "@niantic//bzl/conditions:x86-any": [
        ...
        "@niantic//bzl/conditions:arm-any": [
    ...
    copts = [
        ...
        "@niantic//bzl/conditions:x86_32": [
            "-DDEFLATE_SLIDE_HASH_SSE2",
            "-DINFLATE_CHUNK_SIMD_SSE2",
            "-DADLER32_SIMD_SSSE3",
        ],
        "@niantic//bzl/conditions:x86_64": [
        ...
        "@niantic//bzl/conditions:osx-x86_64": [
            "-msse4.2",
            "-mpclmul",
            "-DX86_NOT_WINDOWS",
            "-DZ_HAVE_UNISTD_H=1",
    ...
    deps = select({
        "@niantic//bzl/conditions:android": [
            "@niantic//bzl/android:cpu-features",
        ],
        "//conditions:default": [],
    }),
)
