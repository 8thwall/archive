/**
 * FORKED FROM THE ANDROID SUPPORT LIBRARY.
 * Allows for C8 to include this class without depending on the entire support library.
 *
 ...
 *
 * {@sample
 * frameworks/support/samples/Support4Demos/src/main/java/com/example/android/supportv4/app/SimpleJobIntentService.java
 *      complete}
 */
public abstract class JobIntentService extends Service {
  ...
  abstract static class WorkEnqueuer {
    ...
    boolean mHasJobId;
    int mJobId;
    WorkEnqueuer(Context context, ComponentName cn) { mComponentName = cn; }
  ...
  static final class JobServiceEngineImpl
    extends JobServiceEngine implements JobIntentService.CompatJobEngine {
    ...
    final class WrapperWorkItem implements JobIntentService.GenericWorkItem {
      ...
      WrapperWorkItem(JobWorkItem jobWork) { mJobWork = jobWork; }
      @Override
  ...
  static WorkEnqueuer getWorkEnqueuer(
    Context context, ComponentName cn, boolean hasJobId, int jobId) {
