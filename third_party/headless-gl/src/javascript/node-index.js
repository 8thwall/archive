...
const { WebGLRenderingContext, wrapContext, getNull } = require('./webgl-rendering-context')
...
function createContext (width, height, optionsIn) {
  ...
  try {
    ...
    console.error('Failed to create native WebGL context')
  }
  if (!ctx) {
    return null
  }
