...
class WebGLTexture extends Linkable {
  constructor (_, ctx) {
    ...
    this._levelDepth = new Int32Array(32)
    ...
    // Inteded to be reset by calls to (gl.framebufferTexture*)
    this._framebufferBindingDirty = false

    // Only intended for multisampled textures (gl.framebufferTexture2DMultisample)
    this._samples = 1
  }
