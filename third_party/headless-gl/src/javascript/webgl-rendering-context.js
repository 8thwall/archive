...
const { WebGLExport } = require('./native-gl')
...
const { gl, NativeWebGLRenderingContext, NativeWebGLObject: NativeWebGL, getNull } = WebGLExport
...
const DEFAULT_ATTACHMENTS =
  ...
  const availableExtensions = {
    ...
    // Disabling 'stackgl' extensions, used for resizing an offscreen framebuffer/renderbuffer.
...
const privateMethods = ['resize', 'destroy']
  ...
  function wrapContext(ctx) {
    // Headless GL has a mechanism for wrapping a WebGLRenderingContext and
...
export { WebGLRenderingContext, wrapContext, getNull }
