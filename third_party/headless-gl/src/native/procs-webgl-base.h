...
glBindAttribLocation =
  reinterpret_cast<PFNGLBINDATTRIBLOCATIONPROC>(eglGetProcAddress("glBindAttribLocation"));
glDrawArrays = reinterpret_cast<PFNGLDRAWARRAYSPROC>(eglGetProcAddress("glDrawArrays"));
glUniformMatrix2fv =
  reinterpret_cast<PFNGLUNIFORMMATRIX2FVPROC>(eglGetProcAddress("glUniformMatrix2fv"));
glUniformMatrix3fv =
  reinterpret_cast<PFNGLUNIFORMMATRIX3FVPROC>(eglGetProcAddress("glUniformMatrix3fv"));
glUniformMatrix4fv =
  reinterpret_cast<PFNGLUNIFORMMATRIX4FVPROC>(eglGetProcAddress("glUniformMatrix4fv"));
glGenerateMipmap = reinterpret_cast<PFNGLGENERATEMIPMAPPROC>(eglGetProcAddress("glGenerateMipmap"));
glGetAttribLocation =
  reinterpret_cast<PFNGLGETATTRIBLOCATIONPROC>(eglGetProcAddress("glGetAttribLocation"));
...
glGetShaderInfoLog =
  reinterpret_cast<PFNGLGETSHADERINFOLOGPROC>(eglGetProcAddress("glGetShaderInfoLog"));
...
glGetUniformLocation =
  reinterpret_cast<PFNGLGETUNIFORMLOCATIONPROC>(eglGetProcAddress("glGetUniformLocation"));
...
glGenFramebuffers =
  reinterpret_cast<PFNGLGENFRAMEBUFFERSPROC>(eglGetProcAddress("glGenFramebuffers"));
glBindFramebuffer =
  reinterpret_cast<PFNGLBINDFRAMEBUFFERPROC>(eglGetProcAddress("glBindFramebuffer"));
...
glVertexAttribPointer =
  reinterpret_cast<PFNGLVERTEXATTRIBPOINTERPROC>(eglGetProcAddress("glVertexAttribPointer"));
...
glBlendFuncSeparate =
  reinterpret_cast<PFNGLBLENDFUNCSEPARATEPROC>(eglGetProcAddress("glBlendFuncSeparate"));
...
glCopyTexSubImage2D =
  reinterpret_cast<PFNGLCOPYTEXSUBIMAGE2DPROC>(eglGetProcAddress("glCopyTexSubImage2D"));
...
glGetShaderPrecisionFormat = reinterpret_cast<PFNGLGETSHADERPRECISIONFORMATPROC>(
...
glStencilFuncSeparate =
  reinterpret_cast<PFNGLSTENCILFUNCSEPARATEPROC>(eglGetProcAddress("glStencilFuncSeparate"));
glStencilMask = reinterpret_cast<PFNGLSTENCILMASKPROC>(eglGetProcAddress("glStencilMask"));
glStencilMaskSeparate =
  reinterpret_cast<PFNGLSTENCILMASKSEPARATEPROC>(eglGetProcAddress("glStencilMaskSeparate"));
glStencilOp = reinterpret_cast<PFNGLSTENCILOPPROC>(eglGetProcAddress("glStencilOp"));
glStencilOpSeparate =
  reinterpret_cast<PFNGLSTENCILOPSEPARATEPROC>(eglGetProcAddress("glStencilOpSeparate"));
glScissor = reinterpret_cast<PFNGLSCISSORPROC>(eglGetProcAddress("glScissor"));
glBindRenderbuffer =
  reinterpret_cast<PFNGLBINDRENDERBUFFERPROC>(eglGetProcAddress("glBindRenderbuffer"));
glGenRenderbuffers =
  reinterpret_cast<PFNGLGENRENDERBUFFERSPROC>(eglGetProcAddress("glGenRenderbuffers"));
glFramebufferRenderbuffer = reinterpret_cast<PFNGLFRAMEBUFFERRENDERBUFFERPROC>(
...
glDeleteFramebuffers =
  reinterpret_cast<PFNGLDELETEFRAMEBUFFERSPROC>(eglGetProcAddress("glDeleteFramebuffers"));
glDeleteProgram = reinterpret_cast<PFNGLDELETEPROGRAMPROC>(eglGetProcAddress("glDeleteProgram"));
glDeleteRenderbuffers =
  reinterpret_cast<PFNGLDELETERENDERBUFFERSPROC>(eglGetProcAddress("glDeleteRenderbuffers"));
...
glRenderbufferStorage =
  reinterpret_cast<PFNGLRENDERBUFFERSTORAGEPROC>(eglGetProcAddress("glRenderbufferStorage"));
glGetShaderSource =
  reinterpret_cast<PFNGLGETSHADERSOURCEPROC>(eglGetProcAddress("glGetShaderSource"));
glValidateProgram =
  reinterpret_cast<PFNGLVALIDATEPROGRAMPROC>(eglGetProcAddress("glValidateProgram"));
...
glGetActiveAttrib =
  reinterpret_cast<PFNGLGETACTIVEATTRIBPROC>(eglGetProcAddress("glGetActiveAttrib"));
glGetActiveUniform =
  reinterpret_cast<PFNGLGETACTIVEUNIFORMPROC>(eglGetProcAddress("glGetActiveUniform"));
glGetAttachedShaders =
  reinterpret_cast<PFNGLGETATTACHEDSHADERSPROC>(eglGetProcAddress("glGetAttachedShaders"));
glGetProgramInfoLog =
  reinterpret_cast<PFNGLGETPROGRAMINFOLOGPROC>(eglGetProcAddress("glGetProgramInfoLog"));
...
glGetVertexAttribiv =
  reinterpret_cast<PFNGLGETVERTEXATTRIBIVPROC>(eglGetProcAddress("glGetVertexAttribiv"));
glGetVertexAttribfv =
  reinterpret_cast<PFNGLGETVERTEXATTRIBFVPROC>(eglGetProcAddress("glGetVertexAttribfv"));
...
glGetTexParameterfv =
  reinterpret_cast<PFNGLGETTEXPARAMETERFVPROC>(eglGetProcAddress("glGetTexParameterfv"));
glGetTexParameteriv =
  reinterpret_cast<PFNGLGETTEXPARAMETERIVPROC>(eglGetProcAddress("glGetTexParameteriv"));
glGetShaderiv = reinterpret_cast<PFNGLGETSHADERIVPROC>(eglGetProcAddress("glGetShaderiv"));
glGetVertexAttribPointerv = reinterpret_cast<PFNGLGETVERTEXATTRIBPOINTERVPROC>(
