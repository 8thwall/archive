...
/// @ingroup type_conversions
/// Upcasts to @c ::ArTrackable.
inline ArTrackable *ArAsTrackable(ArInstantPlacementPoint *instant_placement_point) {
    return reinterpret_cast<ArTrackable *>(instant_placement_point);
}

/// @ingroup type_conversions
/// Downcasts to @c ::ArInstantPlacementPoint.
inline ArInstantPlacementPoint *ArAsInstantPlacementPoint(ArTrackable *trackable) {
...
void ArConfig_setInstantPlacementMode(const ArSession *session,
                                      ArConfig *config,
                                      ArInstantPlacementMode instant_placement_mode);

/// @ingroup ArConfig
/// Gets the current Instant Placement Region mode from the @c ::ArConfig.
void ArConfig_getInstantPlacementMode(const ArSession *session,
                                      const ArConfig *config,
                                      ArInstantPlacementMode *instant_placement_mode);
...
void ArCameraConfig_getFacingDirection(const ArSession *session,
                                       const ArCameraConfig *camera_config,
...
// TODO(b/166280987) Finalize documentation
void ArCameraConfig_getStereoCameraUsage(const ArSession *session,
                                         const ArCameraConfig *camera_config,
...
///     together
void ArCameraConfigFilter_setDepthSensorUsage(const ArSession *session,
                                              ArCameraConfigFilter *filter,
...
///     together
// TODO(b/166280987) Finalize documentation
void ArCameraConfigFilter_setStereoCameraUsage(const ArSession *session,
                                               ArCameraConfigFilter *filter,
...
// TODO(b/166280987) Finalize documentation
void ArCameraConfigFilter_getStereoCameraUsage(const ArSession *session,
                                               ArCameraConfigFilter *filter,
...
/// - @c #AR_ERROR_RESOURCE_EXHAUSTED
/// - @c #AR_ERROR_ANCHOR_NOT_SUPPORTED_FOR_HOSTING
ArStatus ArSession_hostAndAcquireNewCloudAnchorWithTtl(ArSession *session,
                                                       const ArAnchor *anchor,
                                                       int32_t ttl_days,
                                                       ArAnchor **out_cloud_anchor);
...
void ArCamera_getTrackingFailureReason(const ArSession *session,
                                       const ArCamera *camera,
...
void ArFrame_transformDisplayUvCoords(const ArSession *session,
                                      ...
                                      const float *uvs_in,
                                      float *uvs_out)
        AR_DEPRECATED("Deprecated in release 1.7.0. Please see function documentation.");
...
void ArImage_getNdkImage(const ArImage *image, const AImage **out_ndk_image)
        AR_DEPRECATED("Deprecated in release 1.10.0. Please see function documentation");
...
///   y, z].
void ArLightEstimate_getEnvironmentalHdrMainLightDirection(const ArSession *session,
                                                           const ArLightEstimate *light_estimate,
...
void ArLightEstimate_getEnvironmentalHdrMainLightIntensity(const ArSession *session,
                                                           const ArLightEstimate *light_estimate,
...
void ArLightEstimate_acquireEnvironmentalHdrCubemap(const ArSession *session,
                                                    const ArLightEstimate *light_estimate,
...
void ArInstantPlacementPoint_getPose(const ArSession *session,
...
void ArAugmentedImage_getTrackingMethod(const ArSession *session,
...
void ArAugmentedFace_getMeshTextureCoordinates(const ArSession *session,
                                               const ArAugmentedFace *face,
...
void ArAugmentedFace_getMeshTriangleIndices(const ArSession *session,
                                            const ArAugmentedFace *face,
...
// TODO(b/161001774) Finalize documentation
ArStatus ArImageMetadata_getConstEntry(const ArSession *session,
                                       const ArImageMetadata *image_metadata,
                                       uint32_t tag,
