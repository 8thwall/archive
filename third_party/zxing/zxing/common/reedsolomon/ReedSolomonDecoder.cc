...
cc_library {
  ...
  deps = {
    ...
    "//third_party/zxing/zxing:IllegalStateException",
...
#include <memory>
#include "third_party/zxing/zxing/common/reedsolomon/ReedSolomonDecoder.h"
...
#include "third_party/zxing/zxing/IllegalStateException.h"
