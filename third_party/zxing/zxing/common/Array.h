...
class AC {
public:
  static int64_t globalArrayObj;
  static int64_t globalArrayNew;
  static int64_t globalArrayDel;

  static int64_t globalArrayRefObj;
  static int64_t globalArrayRefNew;
  static int64_t globalArrayRefDel;
};
...
public:
  ...
  ArrayRef() :
      array_(0) {
    ++AC::globalArrayRefObj;
    ++AC::globalArrayRefNew;
  }
