...
cc_library {
  ...
  deps = {
    ":MathUtils",
    "//third_party/zxing/zxing:NotFoundException",
    "//third_party/zxing/zxing:ReaderException",
    "//third_party/zxing/zxing:ResultPoint",
...
#include "third_party/zxing/zxing/NotFoundException.h"
#include "third_party/zxing/zxing/common/detector/WhiteRectangleDetector.h"
