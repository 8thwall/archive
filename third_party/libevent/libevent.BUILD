...
cc_library(
    ...
    srcs = [
      ...
      "@niantic//bzl/conditions:windows": [":windows-srcs"],
      "//conditions:default": [],
    }),
    hdrs = [
        # Included headers.
    ...
    deps = [
        "@niantic//third_party/libevent:platform-specific-headers",
    ] + select({
        "@niantic//bzl/conditions:apple": [],
        "//conditions:default": ["@niantic//third_party/libevent:arc4random"],
    }),
)
