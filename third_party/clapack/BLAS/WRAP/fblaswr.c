// We want to make sure that fblaswr.cc doesn't make it into our codebase. We might want it if we
// had an alternate implementation of the impl_ files.
#define EXCLUDE_FBLASWR
#ifndef EXCLUDE_FBLASWR
...
doublereal f2c_sdot(integer *N, real *X, integer *incX, real *Y, integer *incY) {
  return sdot_(N, X, incX, Y, incY);
}

doublereal f2c_ddot(integer *N, doublereal *X, integer *incX, doublereal *Y, integer *incY) {
...
void f2c_cdotu(complex *retval, integer *N, complex *X, integer *incX, complex *Y, integer *incY) {
  cdotu_(retval, N, X, incX, Y, incY);
}

void f2c_cdotc(complex *retval, integer *N, complex *X, integer *incX, complex *Y, integer *incY) {
...
doublereal f2c_snrm2(integer *N, real *X, integer *incX) { return snrm2_(N, X, incX); }

doublereal f2c_sasum(integer *N, real *X, integer *incX) { return sasum_(N, X, incX); }

doublereal f2c_dnrm2(integer *N, doublereal *X, integer *incX) { return dnrm2_(N, X, incX); }

doublereal f2c_dasum(integer *N, doublereal *X, integer *incX) { return dasum_(N, X, incX); }

doublereal f2c_scnrm2(integer *N, complex *X, integer *incX) { return scnrm2_(N, X, incX); }

doublereal f2c_scasum(integer *N, complex *X, integer *incX) { return scasum_(N, X, incX); }

doublereal f2c_dznrm2(integer *N, doublecomplex *X, integer *incX) { return dznrm2_(N, X, incX); }

doublereal f2c_dzasum(integer *N, doublecomplex *X, integer *incX) { return dzasum_(N, X, incX); }

/*
 * Functions having standard 4 prefixes (S D C Z)
 */
integer f2c_isamax(integer *N, real *X, integer *incX) { return isamax_(N, X, incX); }

integer f2c_idamax(integer *N, doublereal *X, integer *incX) { return idamax_(N, X, incX); }

integer f2c_icamax(integer *N, complex *X, integer *incX) { return icamax_(N, X, incX); }

integer f2c_izamax(integer *N, doublecomplex *X, integer *incX) { return izamax_(N, X, incX); }
...
int f2c_sswap(integer *N, real *X, integer *incX, real *Y, integer *incY) {
  sswap_(N, X, incX, Y, incY);
  return 0;
}

int f2c_scopy(integer *N, real *X, integer *incX, real *Y, integer *incY) {
  scopy_(N, X, incX, Y, incY);
  return 0;
}

int f2c_saxpy(integer *N, real *alpha, real *X, integer *incX, real *Y, integer *incY) {
  saxpy_(N, alpha, X, incX, Y, incY);
  return 0;
}

int f2c_dswap(integer *N, doublereal *X, integer *incX, doublereal *Y, integer *incY) {
...
int f2c_daxpy(
  integer *N, doublereal *alpha, doublereal *X, integer *incX, doublereal *Y, integer *incY) {
  daxpy_(N, alpha, X, incX, Y, incY);
  return 0;
}

int f2c_cswap(integer *N, complex *X, integer *incX, complex *Y, integer *incY) {
  cswap_(N, X, incX, Y, incY);
  return 0;
}

int f2c_ccopy(integer *N, complex *X, integer *incX, complex *Y, integer *incY) {
  ccopy_(N, X, incX, Y, incY);
  return 0;
}

int f2c_caxpy(integer *N, complex *alpha, complex *X, integer *incX, complex *Y, integer *incY) {
  caxpy_(N, alpha, X, incX, Y, incY);
  return 0;
}

int f2c_zswap(integer *N, doublecomplex *X, integer *incX, doublecomplex *Y, integer *incY) {
  zswap_(N, X, incX, Y, incY);
  return 0;
}

int f2c_zcopy(integer *N, doublecomplex *X, integer *incX, doublecomplex *Y, integer *incY) {
...
int f2c_srotg(real *a, real *b, real *c, real *s) {
  srotg_(a, b, c, s);
  return 0;
}

int f2c_srot(integer *N, real *X, integer *incX, real *Y, integer *incY, real *c, real *s) {
  srot_(N, X, incX, Y, incY, c, s);
  return 0;
}

int f2c_drotg(doublereal *a, doublereal *b, doublereal *c, doublereal *s) {
  drotg_(a, b, c, s);
  return 0;
}
...
int f2c_sscal(integer *N, real *alpha, real *X, integer *incX) {
...
int f2c_cscal(integer *N, complex *alpha, complex *X, integer *incX) {
  cscal_(N, alpha, X, incX);
  return 0;
}

int f2c_zscal(integer *N, doublecomplex *alpha, doublecomplex *X, integer *incX) {
  zscal_(N, alpha, X, incX);
  return 0;
}

int f2c_csscal(integer *N, real *alpha, complex *X, integer *incX) {
  csscal_(N, alpha, X, incX);
  return 0;
}

int f2c_zdscal(integer *N, doublereal *alpha, doublecomplex *X, integer *incX) {
...
int f2c_strmv(
  char *uplo, char *trans, char *diag, integer *N, real *A, integer *lda, real *X, integer *incX) {
...
int f2c_dtpmv(
  char *uplo, char *trans, char *diag, integer *N, doublereal *Ap, doublereal *X, integer *incX) {
...
int f2c_ctpmv(
  char *uplo, char *trans, char *diag, integer *N, complex *Ap, complex *X, integer *incX) {
...
int f2c_sspr2(
  char *uplo, integer *N, real *alpha, real *X, integer *incX, real *Y, integer *incY, real *A) {
...
int f2c_dspr(
  char *uplo, integer *N, doublereal *alpha, doublereal *X, integer *incX, doublereal *Ap) {
...
int f2c_cher(
  char *uplo, integer *N, real *alpha, complex *X, integer *incX, complex *A, integer *lda) {
...
int f2c_zhpr(
  char *uplo, integer *N, doublereal *alpha, doublecomplex *X, integer *incX, doublecomplex *Ap) {
