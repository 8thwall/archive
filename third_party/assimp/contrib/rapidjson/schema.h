...
public:
  ...
  bool Key(Context &context, const Ch *str, SizeType len, bool) const {
    ...
    if (context.patternPropertiesSchemaCount == 0)  // patternProperties are not additional
                                                    // properties
  ...
  */
  explicit GenericSchemaDocument(
    ...
    new (typeless_) SchemaType(
      this, PointerType(), ValueType(kObjectType).Move(), ValueType(kObjectType).Move(), 0);
