...
import {Font, FONTS, DEFAULT_FONT, DEFAULT_FONT_NAME} from '../shared/fonts'
...
const fetchExistingFont = (font: string): FontMtsdf | null => {
  if (FONTS.has(font)) {
...
const resolveFont = async (font: string): Promise<FontMtsdf> => {
...
const update3dUi = (
  ...
  let font: FontMtsdf = DEFAULT_FONT
