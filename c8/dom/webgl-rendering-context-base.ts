...
import type {HTMLVideoElement} from './html-elements'
...
type TexImageSource = ImageBitmap | ImageData | HTMLImageElement |
  HTMLCanvasElement | HTMLVideoElement | OffscreenCanvas | VideoFrame

type Float32List = Array<GLfloat>
type Int32List = Array<GLint>
