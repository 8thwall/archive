...
import type {
  WebGLRenderingContextOverloads, AllowSharedBufferSource,
...
implements WebGLRenderingContextBase, WebGLRenderingContextOverloads {
  ...
  isContextLost(): GLboolean

  activeTexture(texture: GLenum): void

  attachShader(program: WebGLProgram | null, shader: WebGLShader | null): void

  bindAttribLocation(program: WebGLProgram | null, index: GLuint, name: DOMString): void
  ...
  getAttribLocation(program: WebGLProgram | null, name: DOMString): GLint
  ...
  getExtension(name: DOMString): any
  ...
  getProgramParameter(program: WebGLProgram | null, pname: GLenum): any

  getRenderbufferParameter(target: GLenum, pname: GLenum): any

  getShaderInfoLog(shader: WebGLShader | null): string | null

  getShaderParameter(shader: WebGLShader | null, pname: GLenum): any
  ...
  getUniformLocation(program: WebGLProgram | null, name: DOMString): WebGLUniformLocation | null
  ...
  shaderSource(shader: WebGLShader | null, source: DOMString): void
  ...
  // Extra niantic function for swapping the buffers of an underlying ANGLE context.
  eglSwapBuffers(): void
}

declare function createContext(width: number, height: number, options: any): WebGLRenderingContext
