...
import type {ConsoleServerUrl} from './console-server-url-types'
import type {StudiohubProtocol} from './studiohub-protocol-types'
...
type ElectronApi = {
  consoleServerUrl: ConsoleServerUrl
  os: OsType
