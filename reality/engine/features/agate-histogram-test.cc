...
class AgateHistogramTest : public ::testing::Test {
public:
  AgateHistogramTest() : ctx(OffscreenGlContext::createRGBA8888Context()) {
...
TEST_F(AgateHistogramTest, HistogramExtraction) {
  ScopeTimer rt("test");
