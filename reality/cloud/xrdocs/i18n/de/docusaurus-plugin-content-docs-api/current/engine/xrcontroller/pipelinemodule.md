...
| Intrinsics     | `[Nummer]`                                                                   | Eine 16-dimensionale spaltengroße 4x4-Projektionsmatrix, die der Szenekamera das gleiche Sichtfeld wie dem gerenderten Kamerabild gibt.                                                                                    |
| trackingStatus | `String`                                                                     | Eine der Optionen `'LIMITED'` oder `'NORMAL'`.                                                                                                                                                                             |
| trackingReason | `Zeichenfolge`                                                               | Eines von "UNSPECIFIED" oder "INITIALIZING".                                                                                                                                                                               |
...
| Eigentum     | Typ    | Beschreibung                                                                                   |
| ------------ | ------ | ---------------------------------------------------------------------------------------------- |
| scaledWidth  | Nummer | Die Breite des Bildes in der Szene, multipliziert mit dem Maßstab.             |
...
| imageUrl | `Zeichenfolge` | URL zu einem repräsentativen Bild für diesen Projektstandort. |
