...
Dieses Ereignis wird von [`xrface`](/legacy/api/aframe/#face-effects) ausgelöst, wenn ein Gesicht nicht mehr verfolgt wird.

`xrfacelost.detail : {id}`

| Eigentum | Beschreibung                                                       |
| -------- | ------------------------------------------------------------------ |
| id       | Eine numerische Kennung für das verlorene Gesicht. |
