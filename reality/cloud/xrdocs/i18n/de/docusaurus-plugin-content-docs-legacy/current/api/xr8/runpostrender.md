...
**WICHTIG**: Stellen Sie sicher, dass [`onStart`](/legacy/api/camerapipelinemodule/onstart) vor dem Aufruf von `XR8.runPreRender()` / `XR8.runPostRender()` aufgerufen wurde.
