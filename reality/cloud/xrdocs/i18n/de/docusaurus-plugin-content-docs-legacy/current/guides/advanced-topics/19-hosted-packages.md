...
## Wand CDN {#8th-wall-cdn}

8th Wall hostet eine Vielzahl von Paketen, die auf bestimmte Versionen in unserem CDN fixiert sind, um die Handhabung zu erleichtern.
...
## Laden bestimmter Engine Chunks

Um die Downloadgröße für den Endbenutzer zu minimieren, können Sie mit den folgenden Methoden selektiv nur die erforderlichen Funktionen der Engine laden.

### Cloud-Editor

Sie können angeben, welche Teile vorgeladen werden sollen, indem Sie den folgenden Meta-Tag in "head.html" einfügen.

- Akzeptierte Chunks: "Slam", "Hand", "Gesicht".
...
Alternativ können Sie die erforderlichen Teile auch durch Hinzufügen des folgenden Skript-Tags definieren:

- Akzeptierte Chunks sind "Slam", "Hand", "Face".
