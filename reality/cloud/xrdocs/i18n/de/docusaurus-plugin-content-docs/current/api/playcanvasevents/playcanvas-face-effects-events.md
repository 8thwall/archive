...
**xr:lefteyebrowraised**: Wird ausgelöst, wenn die linke Augenbraue eines verfolgten Gesichts gegenüber der Ausgangsposition beim Auffinden des Gesichts angehoben wird.

`xr:lefteyebrowraised : {id}`

**xr:lefteyebrowlowered**: Wird ausgelöst, wenn die linke Augenbraue eines verfolgten Gesichts auf ihre ursprüngliche Position gesenkt wird, als das Gesicht gefunden wurde.
...
**xr:righteyebrowlowered**: Wird ausgelöst, wenn die rechte Augenbraue eines verfolgten Gesichts auf ihre ursprüngliche Position gesenkt wird, als das Gesicht gefunden wurde.
...
```javascript
  ...
  // Wird ausgelöst, wenn anschließend ein Gesicht gefunden wird.
