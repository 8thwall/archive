...
Stellt ein Kamera-Pipeline-Modul zur Verfügung, das Bildschirmfotos der aktuellen Szene erstellen kann.
...
| [takeScreenshot](takescreenshot.md)           | Gibt ein Versprechen zurück, das, wenn es aufgelöst wird, einen Puffer mit dem JPEG-komprimierten Bild bereitstellt. Bei Ablehnung wird eine Fehlermeldung angezeigt. |
