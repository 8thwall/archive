...
Dieses Ereignis wird von [`xrhand`](/api/aframe/#hand-tracking) ausgelöst, wenn eine Hand nicht mehr verfolgt wird.

`xrhandlost.detail : {id}`

| Eigentum | Beschreibung                                    |
| -------- | ----------------------------------------------- |
| id       | Eine numerische ID der Hand, die verloren ging. |
