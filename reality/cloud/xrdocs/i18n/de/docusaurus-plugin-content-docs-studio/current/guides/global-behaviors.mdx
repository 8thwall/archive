...
{frontMatter.description} Im Gegensatz zu Komponenten, die jeweils nur auf ein einzelnes Entity wirken, kann ein Verhalten Abfragen verwenden, um übereinstimmende Entities aufzuzählen und auf sie als Gruppe zu wirken.
