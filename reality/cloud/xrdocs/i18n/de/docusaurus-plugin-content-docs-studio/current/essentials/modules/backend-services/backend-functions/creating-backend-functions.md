...
:::info
Die Backend-Funktion muss eine **async-Methode** namens "Handler" exportieren.  Weitere Informationen finden Sie in der Dokumentation [Writing Backend Code](/studio/essentials/modules/backend-services/backend-functions/writing-backend-code/).
:::
