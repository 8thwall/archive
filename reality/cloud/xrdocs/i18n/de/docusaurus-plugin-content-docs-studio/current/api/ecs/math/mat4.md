...
Erzeugt eine Matrix mit direkt angegebenen Daten unter Verwendung der Spalten-Hauptreihenfolge. Optional kann eine Umkehrung angegeben werden. Falls nicht angegeben, wird die Inverse automatisch berechnet, wenn die Matrix invertierbar ist. Der Versuch, die Inverse für eine nicht invertierbare Matrix zu berechnen, führt zu einem Fehler.
...
Invertiert die Matrix, oder wirft, wenn die Matrix nicht invertierbar ist. Da Mat4 eine vorberechnete Umkehrung speichert, ist dieser Vorgang sehr schnell.
...
Ermittelt eine Matrix mit der gleichen Position und Skalierung wie diese Matrix, aber mit einer Drehung, die auf das Ziel ausgerichtet ist.
...
Multiplikation der Matrix mit einem Vektor unter Verwendung homogener Koordinaten.
...
Invertiert die Matrix, oder wirft, wenn die Matrix nicht invertierbar ist. Da Mat4 eine vorberechnete Umkehrung speichert, ist dieser Vorgang sehr schnell. Speichert das Ergebnis in diesem Mat4 und gibt dieses Mat4 zur Verkettung zurück.
...
Setzt diese Matrix auf das Ergebnis von m mal diese Matrix. Speichert das Ergebnis in diesem Mat4 und gibt dieses Mat4 zur Verkettung zurück.
