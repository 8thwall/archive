...
Este evento es emitido por [`xrhand`](/legacy/api/aframe/#hand-tracking) cuando se encuentra una mano por primera vez.

\`xrhandfound.detail : {id, transform, vertices, normales, handKind, attachmentPoints}\`\`
