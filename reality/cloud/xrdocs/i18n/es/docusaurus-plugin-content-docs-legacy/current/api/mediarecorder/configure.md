...
| enableEndCard [Opcional]        | Cadena   | `false`                                                                        | Si es true, habilita la tarjeta final.                                                                                                                                                                                                                                                                                                               |
| endCardCallToAction [Opcional]  | Cadena   | `'Pruébalo en: '`                                                              | Establece la cadena de texto para la llamada a la acción.                                                                                                                                                                                                                                                                                            |
| fileNamePrefix [Opcional]       | Cadena   | `'mi-captura-'`                                                                | Establece la cadena de texto que antepone la marca de tiempo única al nombre del archivo.                                                                                                                                                                                                                                                            |
| footerImageUrl [Opcional]       | Cadena   | "null                                                                          | Image src for cover image.                                                                                                                                                                                                                                                                                                                           |
| foregroundCanvas [Opcional]     | Cadena   | "null                                                                          | El lienzo que se utilizará como primer plano en el vídeo grabado.                                                                                                                                                                                                                                                                                    |
| maxDurationMs [Opcional]        | `Número` | `15000`                                                                        | Duración máxima del vídeo, en milisegundos.                                                                                                                                                                                                                                                                                                          |
| maxDimension [Opcional]         | `Número` | `1280`                                                                         | Dimensión máxima de la grabación capturada, en píxeles.                                                                                                                                                                                                                                                                                              |
...
| configureAudioOutput [Opcional] | Objeto   | "null                                                                          | Función proporcionada por el usuario que recibirá los nodos de audio `microphoneInput` y `audioProcessor` para un control completo del audio de la grabación. Los nodos conectados al nodo procesador de audio formarán parte del audio de la grabación. Debe devolver el nodo final del grafo de audio del usuario. |
...
| audioProcessor  | un [`ScriptProcessorNode`](https://developer.mozilla.org/en-US/docs/Web/API/ScriptProcessorNode) que pasa los datos de audio a la grabadora. Si quieres que un nodo de audio forme parte de la salida de audio de la grabación, debes conectarlo al audioProcessor. |
...
XR8.MediaRecorder.configure({
  maxDurationMs: 15000,
  enableEndCard: true,
  endCardCallToAction: 'Pruébalo en:',
  shortLink: '8th.io/mi-enlace',
})
```
