...
Si ha configurado un [dominio conectado] (/account/projects/connected-domains/) para su 8º proyecto alojado en
Wall, tendrá la opción de establecer el destino del código QR / enlace corto en la URL predeterminada
del proyecto o en el dominio conectado principal.
