...
sidebar_class_name: oculto
title: Documentación de la 8ª Muralla
description: Documentación de la 8ª Muralla
---
...
```mdx-code-block
  <div className="doc-container">
    ...
    # Documentación
    Construya, lance y escale juegos web y experiencias WebAR de clase mundial con 8th Wall.
    ...
    <div class="hero-banner">
      <a href="/docs/migration/" class="hero-link">
        <div class="hero-content">
          ...
          <div class="hero-text">
            <h2 class="hero-title">Guía de migración</h2>
            <p class="hero-description">
              Obtenga más información sobre los cambios en el negocio de 8th Wall y cómo prepararse para el código abierto.
            </p>
          </div>
          <div class="hero-cta">
            Más información
    ...
    <div className="doc-grid">
      <a href="account" className="doc-card-link">
        <div className="doc-card">
          ...
          <div className="doc-card-content">
            <h3 className="doc-card-title">Cuenta y facturación</h3>
            <p className="doc-card-description">Acceda a la documentación para gestionar su cuenta de 8th Wall.</p>
          </div>
        </div>
      </a>
      ...
      <a href="studio" className="doc-card-link">
        <div className="doc-card">
          ...
          <div className="doc-card-content">
            <h3 className="doc-card-title">Estudio</h3>
            <p className="doc-card-description">Acceda a la documentación del nuevo kit de herramientas Studio de 8th Wall.</p>
          </div>
        </div>
      </a>
      ...
      <a href="api" className="doc-card-link">
        <div className="doc-card">
          ...
          <div className="doc-card-content">
            ...
            <p className="doc-card-description">Acceda a la documentación de la API JavaScript de 8th Wall.</p>
          </div>
        </div>
      </a>
    </div>
    ...
    <div className="resources-section">
      <h2 className="resources-title">Recursos adicionales</h2>
      <div className="resources-grid">
        <a href="https://8thwall.com/forum" target="_blank" className="resource-card">
          ...
          <div className="resource-content">
            <h3 className="resource-title">Foro</h3>
            <p className="resource-description">Conéctese con otros desarrolladores, formule preguntas y comparta ideas mientras construye con 8th Wall.</p>
          </div>
        </a>
        <a href="https://8th.io/discord" target="_blank" className="resource-card">
          ...
          <div className="resource-content">
            ...
            <p className="resource-description">Únase a nuestra comunidad de desarrolladores para obtener asistencia en tiempo real, mejores prácticas y actualizaciones sobre nuevas funciones.</p>
          </div>
        </a>
      </div>
    </div>
