...
Este evento es emitido por [`xrweb`](/api/aframe/#world-tracking-image-targets-andor-lightship-vps) cuando se encuentra por primera vez un objetivo de imagen.
