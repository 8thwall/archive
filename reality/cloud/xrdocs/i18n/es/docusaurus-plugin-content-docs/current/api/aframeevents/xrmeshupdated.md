...
Este evento es emitido por [`xrweb`](/api/aframe/#world-tracking-image-targets-andor-lightship-vps) cuando la primera malla **** encontrada cambia de posición o rotación.
