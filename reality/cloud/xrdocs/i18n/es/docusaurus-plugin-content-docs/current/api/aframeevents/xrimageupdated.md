...
Este evento lo emite [`xrweb`](/api/aframe/#world-tracking-image-targets-andor-lightship-vps) cuando un objetivo de imagen cambia de posición, rotación o escala.
