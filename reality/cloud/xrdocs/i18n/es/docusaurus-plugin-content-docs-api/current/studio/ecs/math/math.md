...
Esta biblioteca incluye tipos y funciones para manejar diferentes tipos de matemáticas.

## Compatibilidad

Los tipos de `ecs.math` representan paradigmas ampliamente seguidos y pueden puentearse fácilmente con otras bibliotecas.

### tres.js

Los tipos en `ecs.math` pueden ser convertidos a y desde los correspondientes tipos matemáticos de three.js `THREE.Vector3`, `THREE.Quaternion`, y `THREE.Matrix4` siguiendo los siguientes ejemplos.
