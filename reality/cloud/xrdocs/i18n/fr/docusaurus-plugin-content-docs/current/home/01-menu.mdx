...
title: Documentation sur le 8e mur
description: Documentation sur le 8e mur
---
...
```mdx-code-block
  <div className="doc-container">
    ...
    # Documentation
    Construire, lancer et mettre à l'échelle des jeux web et des expériences WebAR de classe mondiale avec 8th Wall.
    ...
    <div class="hero-banner">
      <a href="/docs/migration/" class="hero-link">
        <div class="hero-content">
          ...
          <div class="hero-text">
            <h2 class="hero-title">Guide de migration</h2>
            <p class="hero-description">
              En savoir plus sur les changements apportés à l'entreprise 8th Wall et sur la manière de se préparer à l'open source.
            </p>
          </div>
          <div class="hero-cta">
            En savoir plus
    ...
    <div className="doc-grid">
      <a href="account" className="doc-card-link">
        <div className="doc-card">
          ...
          <div className="doc-card-content">
            <h3 className="doc-card-title">Compte et facturation</h3>
            <p className="doc-card-description">Accédez à la documentation pour la gestion de votre compte 8th Wall.</p>
          </div>
        </div>
      </a>
      ...
      <a href="studio" className="doc-card-link">
        <div className="doc-card">
          ...
          <div className="doc-card-content">
            <h3 className="doc-card-title">Studio</h3>
            <p className="doc-card-description">Accédez à la documentation sur la nouvelle boîte à outils Studio de 8th Wall.</p>
          </div>
        </div>
      </a>
      ...
      <a href="api" className="doc-card-link">
        <div className="doc-card">
          ...
          <div className="doc-card-content">
            ...
            <p className="doc-card-description">Accédez à la documentation sur l'API JavaScript de 8th Wall.</p>
          </div>
        </div>
      </a>
    </div>
    ...
    <div className="resources-section">
      <h2 className="resources-title">Ressources supplémentaires</h2>
      <div className="resources-grid">
        <a href="https://8thwall.com/forum" target="_blank" className="resource-card">
          ...
          <div className="resource-content">
            <h3 className="resource-title">Forum</h3>
            <p className="resource-description">Entrez en contact avec d'autres développeurs, posez des questions et partagez vos idées au fur et à mesure que vous construisez avec 8th Wall.</p>
          </div>
        </a>
        <a href="https://8th.io/discord" target="_blank" className="resource-card">
          ...
          <div className="resource-content">
            ...
            <p className="resource-description">Rejoignez notre communauté de développeurs pour bénéficier d'une assistance en temps réel, des meilleures pratiques et des mises à jour sur les nouvelles fonctionnalités.</p>
          </div>
        </a>
      </div>
    </div>
