...
1. **Réduisez la taille/résolution des textures utilisées dans votre scène** (voir [texture optimization](/guides/your-3d-models-on-the-web/#texture-optimization))
...
#### Exemple : Désactivez les images bitmap d'iOS (ajoutez-les en haut du fichier app.js) : {#example-disable-ios-bitmaps-add-to-the-top-of-appjs}
