...
Les projets 8th Wall fournissent des [analyses d'utilisation de base](/guides/projects/usage-and-recent-trends), vous permettant de voir combien de "vues" votre projet a reçues, ainsi que le temps moyen passé par les utilisateurs de . Si vous souhaitez obtenir des analyses personnalisées ou plus détaillées, nous vous recommandons d'ajouter à votre projet des outils d'analyse Web de tierce partie ( ).

Le processus d'ajout d'analyses à un projet est le même que pour tout site web non AR .  Vous pouvez utiliser la solution analytique de votre choix.

Dans cet exemple, nous allons vous expliquer comment ajouter Google Analytics à votre projet 8th Wall à l'aide de Google Tag Manager (GTM) - ce qui facilitera la collecte d'analyses personnalisées sur la façon dont les utilisateurs consultent votre projet et interagissent avec lui à l'adresse .
...
* Google Analytics 4
  * Pour commencer : <https://support.google.com/analytics/answer/9304153>
...
* Google Tag Manager
  ...
  * Mise en place et installation : <https://support.google.com/tagmanager/answer/6103696>
...
2. Ouvrez le Cloud Editor 8th Wall et collez le bloc de code **top** dans **head.html**:

![GTM2](/images/gtm2.jpg)

3. Cliquez sur "+" à côté de Fichiers, et créez un nouveau fichier appelé **gtm.html**, puis collez le**bas du contenu du bloc de** code bas dans ce fichier :
...
1. Localisez l'identifiant de mesure de Google [](https://support.google.com/analytics/answer/12270356) pour votre flux de données.
2. Dans GTM, [créez une balise GA4 Configuration](https://support.google.com/tagmanager/answer/9442095#config).
...
Les pages vues seront automatiquement suivies par le biais de la balise de configuration GA4. Pour plus d'informations, consultez le site [Configure Google Tag Manager](/guides/advanced-topics/advanced-analytics/#configure-google-tag-manager) .
...
Dans cet exemple, nous allons créer une balise (avec Trigger) et l'ajouter au projet d'exemple ["AFrame : Place Ground"](https://www.8thwall.com/8thwall/placeground-aframe) qui se déclenche à chaque fois qu'un modèle 3D est créé.

#### Créer un déclencheur d'événement personnalisé {#create-custom-event-trigger}
...
#### Évènement à l'intérieur du projet 8th Wall {#fire-event-inside-8th-wall-project}
