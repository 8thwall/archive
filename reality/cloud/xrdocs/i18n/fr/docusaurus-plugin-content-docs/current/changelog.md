...
* Nouvelles fonctionnalités :
  * Ajout de la compatibilité VPS pour les projets Niantic Studio.
...
* Corrections et améliorations :
  * Amélioration de la qualité de la localisation et du suivi sur les sites VPS, ce qui a permis d'améliorer considérablement la stabilité et la précision des expériences de RA sur les sites VPS.
  * SLAM relocalisation optimisée & tracking.
...
#### Version 27 : (2024-Sept-12, v27.0.4.427 / 2024-Août-01, v27.0.2.427) {#release-27-2024-august-01-v2702427}
...
* Nouvelles fonctionnalités :
  * Ajout de la prise en charge des effets de visage et du suivi du monde dans Niantic Studio.
...
* Améliorations de XRExtras :
  * Ajout du paramètre `uv-orientation` à `xrextras-hand-mesh` pour prendre en charge la nouvelle fonctionnalité UV de la main.
...
* Nouvelles fonctionnalités :
  * Ajout de trois nouveaux points d'attache aux oreilles pour Face Effects, ce qui vous permet d'attacher avec précision du contenu RA à différents points des oreilles.
  ...
  * Déploiement métaversal amélioré pour soutenir les expériences 8th Wall sur le Magic Leap 2.
...
* Nouvelles fonctionnalités :
  * Introduction du suivi des mains - utilisez les mains, les poignets et les doigts comme support interactif pour des expériences WebAR immersives.
     ...
     * Ajout d'un module de superposition de coaching des mains pour guider les utilisateurs à travers un flux afin de s'assurer que leurs mains sont dans le champ de la caméra.
...
* Améliorations de XRExtras :
  * Nouveaux composants du cadre A pour faciliter le développement du suivi main.
...
* Améliorations de XRExtras :
  * Ajout du paramètre `face-id` à `xrextras-faceanchor` pour prendre en charge la nouvelle fonctionnalité multi-face. (22.1.7.1958)

#### Version 22 : (2023-avril-20, v22.0.4.1958) {#release-22-2023-april-20-v22041958}

* Nouvelles fonctionnalités :
  * Voici les effets de visage entièrement rafraîchis du moteur 8th Wall :
...
#### Version 21.4 : (2023-avril-07, v21.4.7.997 / 2023-mars-27, v21.4.6.997) {#release-214-2023-april-07-v2147997--2023-march-27-v2146997}

* Nouvelles fonctionnalités :
  * Découvrez les effets de ciel + le suivi du monde - créez des expériences immersives qui augmentent le ciel et le sol dans un seul projet :
...
* Corrections et améliorations :
  ...
  * Ajout de la possibilité de spécifier les emplacements de projet du SPV que vous souhaitez localiser. Cela permet d'améliorer les délais de localisation du SPV s'il y a de nombreux emplacements à proximité.
  * Correction d'un problème où l'ouverture d'expériences PlayCanvas sur le bureau pouvait entraîner un plantage.
...
* Améliorations de XRExtras :
  * MediaRecorder a été amélioré pour ajouter une autre méthode de dessin d'éléments 2D sur le support enregistré.
  * Correction du rendu des ombres dans PlayCanvas v1.55+
  * Amélioration des performances des primitives Image Cible A-Frame.

#### Version 20.3 : (2022-Novembre-22, v20.3.3.684) {#release-203--2022-november-22-v2033684}
...
#### Version 20 : (2022-octobre-05, v20.1.20.684 / 2022-septembre-21, v20.1.19.684 / 2022-septembre-21, v20.1.17.684) {#release-20--2022-october-05-v20120684--2022-september-21-v20119684--2022-september-21-v20117684}
...
* Nouvelles fonctionnalités :
  * Lightship VPS pour le Web - créez des expériences WebAR basées sur la localisation en connectant le contenu AR à des lieux réels.
    * Ajout d'un nouveau navigateur géospatial au portail des développeurs 8th Wall.
      * Trouver, créer et gérer les emplacements activés par le SPV.
      * Générez et téléchargez des maillages 3D pour les utiliser comme occluders, objets physiques ou comme référence pour créer des animations tenant compte de l'emplacement.
    ...
    * Ajout des API `XR8.Vps.makeWayspotWatcher` et `XR8.Vps.projectWayspots` pour interroger les emplacements activés par les VPS et les emplacements de projet à proximité.
...
* Corrections et améliorations :
  * Correction des problèmes liés à l'expérience 8th Wall dans WeChat sur iOS.
  * Amélioration du suivi initial SLAM pour certains appareils Android (19.1.6.390)

#### Version 19 : (2022-Mai-5, v19.0.16.390 / 2022-Avril-13, v19.0.14.390 / 2022-Mars-24, v19.0.8.390) {#release-19--2022-may-5-v19016390--2022-april-13-v19014390--2022-march-24-v1908390}
...
#### Version 18.1 : (2021-décembre-02, v18.1.3.554) {#release-181--2021-december-02-v1813554}
...
#### Version 18 : (2021-Novembre-08, v18.0.6.554) {#release-18--2021-november-08-v1806554}

* Nouvelles fonctionnalités :
  * Nous vous présentons le moteur 8th Wall, entièrement reconstruit et doté d'un système de déploiement métaversal :
...
* Corrections et améliorations :
  ...
  * Amélioration de l'intégration de PlayCanvas pour permettre de dessiner sur le même support que celui sur lequel le flux de la caméra est rendu.

#### Version 17.1 : (2021-Septembre-21, v17.1.3.476) {#release-171--2021-september-21-v1713476}
...
* Nouvelles fonctionnalités :
  * Ajout de nouvelles API
    ...
    * Méthode de cycle pour l'enlèvement des modules de canalisation.
...
* Améliorations de XRExtras :
  ...
  * Amélioration de la gestion du cycle des modules Runtime Error, Almost There et Loading.
  * Mise à jour du module "Presque là" pour améliorer la réussite des scans de codes QR.
  * Amélioration de la logique du support pleine fenêtre sur l'écran partagé de l'iPad.
...
* Corrections et améliorations :
  ...
  * Amélioration de la compatibilité avec l'utilisation de support avec des contextes WebGL 2 prédéfinis.

#### Version 16 : (2021-mai-21, v16.0.8.1227 / 2021-avril-27, v16.0.6.1227 / 2021-avril-22, v16.0.5.1227) {#release-16--2021-may-21-v16081227--2021-april-27-v16061227--2021-april-22-v16051227}
...
* Corrections et améliorations :
  ...
  * Amélioration de la qualité du suivi et de la fréquence d'images de l'expérience Image cible.
  * Amélioration de l'expérience pour certains appareils Android dotés de plusieurs caméras.
...
#### Version 15.2 : (2020-décembre-14, v15.2.4.487) {#release-152--2020-december-14-v1524487}

* Nouvelles fonctionnalités :
  * Ajout de la prise en charge de WKWebView sur les appareils fonctionnant sous iOS 14.3 ou plus récent.
  * Mise en place d'un contexte de calcul accessible aux modules de pipeline afin d'accélérer la vision par ordinateur sur GPU hors écran.
  * Mise à jour de 8Frame pour supporter A-Frame 1.1.0.

* Corrections et améliorations :
  * Amélioration de la compatibilité avec les moteurs de rendu.
  * Ajout de la possibilité de charger et de décharger des cibles d'images tout en suivant d'autres images cible.
...
* Nouvelles fonctionnalités :
  ...
  * Ajout de la prise en charge de A-Frame 1.1.0-beta, THREE 120 et MRCS HoloVideoObject 1.2.5.
...
* Nouvelles fonctionnalités :
  * Images cible courbes 8th Wall :
    * Ajout de la prise en charge des images cible cylindriques telles que celles qui sont enroulées autour de bouteilles, de boîtes de conserve, etc.
    * Ajout de la prise en charge des images cible coniques, telles que celles entourant les tasses à café, les chapeaux de fête, les abat-jour, etc.

* Corrections et améliorations :
  * Amélioration de la qualité du suivi pour les cibles SLAM et les images cible.
  * Correction d'un problème avec les hologrammes MRCS et le routage des appareils sur iOS 14.
  * Correction d'un problème avec les effets de visage et les images cible où les mises à jour de mirroredDisplay n'étaient pas reflétées pendant l'exécution.
  * Amélioration de l'expérience pour certains appareils Android dotés de plusieurs caméras. (v15.0.9.487)
  * Correction d'un problème de raycasting avec AFrame 1.0.x (v15.0.9.487)

* Améliorations de XRExtras :
  * Nouveaux composants AFrame pour faciliter le développement d’image cible courbe :
...
* Nouvelles fonctionnalités :
  * Mise à jour de MediaRecorder.configure() pour offrir plus de contrôle sur la sortie audio et le mixage :
    ...
    * Vous pouvez désactiver l'enregistrement du microphone.
    * Ajoutez vos propres nœuds audio au graphe audio.
    * Incorporez le son de la scène dans la lecture de l'enregistrement.
...
* Nouvelles fonctionnalités :
  * Présentation de l'enregistrement vidéo 8th Wall :
    ...
    * Configurez la durée et la résolution maximales de la vidéo.
...
* Améliorations de XRExtras :
  * Composant préfabriqué de bouton d'enregistrement pour capturer des vidéos et des photos :
    * Sélectionnez les modes de capture standard, fixe et photo.
  * Composant préfabriqué pour la prévisualisation, le téléchargement et le partage des captures
  * Utilisez XRExtras pour personnaliser facilement l'expérience utilisateur de l'enregistrement vidéo dans votre projet :
    * Configurez la longueur et la résolution maximales de la vidéo.
    * Ajoutez un filigrane facultatif à chaque image de la vidéo.
    * Ajoutez une carte de fin facultative pour ajouter une marque et un appel à l'action à la fin de la vidéo.

#### Version 14 : (2020-mai-26) {#release-14--2020-may-26}
...
* Nouvelles fonctionnalités :
  * Libérez le flux de la caméra sur XR8.pause() et rouvrez-le sur XR8.resume().
...
* Nouvelles fonctionnalités :
  ...
  * Nouveaux rappels de cycle pour l'attachement et le détachement.
...
* Corrections et améliorations :
  ...
  * Correction d'un problème de mémoire lors du chargement répété de nombreuses images cible.
...
* Nouvelles fonctionnalités :
  ...
  * Nouvelle API pour la sélection des images cible actives au moment de l'exécution.
  * Les applications peuvent désormais rechercher jusqu'à 10 images cible simultanément.
  * La caméra frontale est prise en charge dans le cadre de la caméra et les images cible.
...
#### Communiqué 11 {#release-11}

* Nouvelles fonctionnalités :
  * Ajout de la prise en charge des images cible.
  * Ajout du support pour BabylonJS.
...
#### Communiqué de presse 10 {#release-10}
...
* Nouvelles fonctionnalités :
  ...
  * XR Extras offre une solution pratique pour :
    ...
    * Redirection des utilisateurs à partir d'appareils ou de navigateurs non pris en charge ("presque arrivé").
...
* Corrections :
  ...
  * Utilisez l'interface window.screen pour l'orientation de l'appareil si elle est disponible.
  * Correction d'un problème avec three.js qui pouvait survenir lorsque le support était redimensionné.
