...
Cet événement est émis par [`xrweb`](/api/aframe/#world-tracking-image-targets-andor-lightship-vps) lorsque tous les emplacements de projet ont été chargés pour être scannés.

`xrprojectwayspotscanning.detail : { wayspots: [] }`

| Propriété     | Description                                                       |
| ------------- | ----------------------------------------------------------------- |
| wayspots : [] | Un tableau d'objets contenant des informations sur l'emplacement. |
