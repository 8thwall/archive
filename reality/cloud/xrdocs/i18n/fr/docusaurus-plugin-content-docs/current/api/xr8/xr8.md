...
| [addCameraPipelineModules](addcamerapipelinemodules.md)       | Ajoutez plusieurs modules de pipeline de caméras. Il s'agit d'une méthode de commodité qui appelle [addCameraPipelineModule](addcamerapipelinemodule.md) dans l'ordre sur chaque élément du tableau d'entrée.              |
| [clearCameraPipelineModules](clearcamerapipelinemodules.md)   | Retirez tous les modules de canalisation de la caméra de la boucle de la caméra.                                                                                                                                           |
| [initialiser](initialize.md)                                  | Renvoie une promesse qui est remplie lorsque le WebAssembly de l'AR Engine est initialisé.                                                                                                                                 |
| [estInitialisé](isinitialized.md)                             | Indique si le WebAssembly du moteur AR est initialisé ou non.                                                                                                                                                              |
| [estPaused](ispaused.md)                                      | Indique si la session XR est en pause ou non.                                                                                                                                                                              |
...
| [résumé](resume.md)                                           | Reprendre la session XR en cours.                                                                                                                                                                                          |
| [removeCameraPipelineModule](removecamerapipelinemodule.md)   | Supprime un module du pipeline de la caméra.                                                                                                                                                                               |
| [removeCameraPipelineModules](removecamerapipelinemodules.md) | Supprimez les modules de pipeline des caméras multiples. Il s'agit d'une méthode de commodité qui appelle [removeCameraPipelineModule](removecamerapipelinemodule.md) dans l'ordre sur chaque élément du tableau d'entrée. |
| [autorisations requises](requiredpermissions.md)              | Renvoyer une liste des autorisations requises par l'application.                                                                                                                                                           |
| [run](run.md)                                                 | Ouvrez l'appareil photo et lancez la boucle d'exécution de l'appareil photo.                                                                                                                                               |
| [runPreRender](runprerender.md)                               | Exécute toutes les mises à jour du cycle qui doivent avoir lieu avant le rendu.                                                                                                                                            |
| [runPostRender](runpostrender.md)                             | Exécute toutes les mises à jour du cycle qui doivent avoir lieu après le rendu.                                                                                                                                            |
| [arrêter](stop.md)                                            | Arrêtez la session XR en cours.  Lorsque l'appareil est à l'arrêt, le flux de la caméra est fermé et les mouvements de l'appareil ne sont pas suivis.                                                                      |
| [version](version.md)                                         | Obtenez la version du moteur 8th Wall Web.                                                                                                                                                                                 |
...
| Module                                                            | Description                                                                                                                                                         |
| ----------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [AFrame](../aframe/aframe.md)                                     | Point d'entrée pour l'intégration du cadre A avec le 8th Wall Web.                                                                                                  |
| [Babylonjs](../babylonjs/babylonjs.md)                            | Point d'entrée pour l'intégration de Babylon.js avec 8th Wall Web.                                                                                                  |
| [CameraPixelArray](../camerapixelarray/camerapixelarray.md)       | Fournit un module de pipeline de caméra qui permet d'accéder aux données de la caméra sous la forme d'un tableau uint8 en niveaux de gris ou en couleurs.           |
| [Capture d’écran Canvas](../canvasscreenshot/canvasscreenshot.md) | Fournit un module de pipeline de caméra qui peut générer des captures d'écran de la scène actuelle.                                                                 |
...
| [GlTextureRenderer](../gltexturerenderer/gltexturerenderer.md)    | Fournit un module de pipeline de caméra qui dessine le flux de la caméra sur un support ainsi que des utilitaires supplémentaires pour les opérations de dessin GL. |
...
| [Vps](../vps/vps.md)                                              | Les services pour parler aux services Vps.                                                                                                                          |
