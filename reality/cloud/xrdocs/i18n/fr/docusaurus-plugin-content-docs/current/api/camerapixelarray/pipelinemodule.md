...
| --------------------------- | ------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| luminance [Optionnel]       | `faux`                                      | Si vrai, la sortie se fait en niveaux de gris au lieu de RGBA                                                                                                                                                                                  |
...
La valeur de retour est un objet mis à la disposition de [`onProcessCpu`](/api/camerapipelinemodule/onprocesscpu) et [`onUpdate`](/api/camerapipelinemodule/onupdate) en tant que :
