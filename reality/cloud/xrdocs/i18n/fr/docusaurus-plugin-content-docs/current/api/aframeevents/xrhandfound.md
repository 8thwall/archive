...
Cet événement est émis par [`xrhand`](/api/aframe/#hand-tracking) lorsqu'une main est trouvée pour la première fois.
...
| points d’attachement : `{ name, position: {x,y,z} }` | Voir [`XR8.HandController.AttachmentPoints`](/api/handcontroller/attachmentpoints) pour la liste des points d'attache disponibles. `position` est relative à la transformation. |
...
| Propriété             | Description                                                                                                                                                   |
| --------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| nom                   | Le nom du point d'attache. Voir [`XR8.HandController.AttachmentPoints`](/api/handcontroller/attachmentpoints) pour la liste des points d'attache disponibles. |
