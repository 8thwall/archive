...
Méthode pratique pour obtenir une structure Viewport qui remplit une texture ou un support à partir d'une source sans distorsion. Il est transmis à la méthode de rendu de l'objet créé par [`XR8.GlTextureRenderer.create()`](create.md)

## Paramètres {#parameters}

| Paramètres           | Type     | Description                               |
| -------------------- | -------- | ----------------------------------------- |
| largeur de la source | `Nombre` | La largeur de la texture que vous rendez. |
