...
| statusText           | `Chaîne`  | `'Scanner...'`                     | Définit la chaîne de texte qui s'affiche sous l'image secondaire lorsqu'elle est réduite.                                                                                                                                                                                                     |
