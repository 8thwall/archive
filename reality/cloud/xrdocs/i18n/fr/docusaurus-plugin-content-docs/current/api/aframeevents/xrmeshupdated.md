...
Cet événement est émis par [`xrweb`](/api/aframe/#world-tracking-image-targets-andor-lightship-vps) lorsque le premier maillage **** trouvé change de position ou de rotation.
