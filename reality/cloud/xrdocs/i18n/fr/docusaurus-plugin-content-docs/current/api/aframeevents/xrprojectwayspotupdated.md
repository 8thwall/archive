...
Cet événement est émis par [`xrweb`](/api/aframe/#world-tracking-image-targets-andor-lightship-vps) lorsqu'un emplacement de projet change de position ou de rotation.
