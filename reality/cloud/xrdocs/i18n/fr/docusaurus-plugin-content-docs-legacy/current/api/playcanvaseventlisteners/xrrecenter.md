...
| face [Facultatif]    | `{w, x, y, z}` | Un quaternion représentant la direction de la caméra à l'origine. |
...
// taprecenter.js : Définit un script playcanvas qui recentre la scène AR lorsque l'on
// touche l'écran.

var taprecenter = pc.createScript('taprecenter')

// Déclenche un événement 'recenter' pour ramener la caméra à son emplacement de départ dans la scène.
