...
| requestMic [Facultatif]                | `Chaîne` | `'auto'`                                                             | Détermine le moment où les autorisations audio sont demandées. Les options sont fournies dans [`XR8.MediaRecorder.RequestMicOptions`](requestmicoptions.md).                                                                                                                                                                                |

La fonction passée à `configureAudioOutput` prend un objet avec les paramètres suivants :
