...
Cet événement est émis par [`xrweb`](/legacy/api/aframe/#world-tracking-image-targets-andor-lightship-vps) lorsqu'un emplacement de projet est trouvé pour la première fois.
