...
[`onProcessGpu`](onprocessgpu.md) seront présentes en tant que `processGpu.modulename` où le nom est donné
...
Toute donnée que vous souhaitez fournir à [`onUpdate`](onupdate.md) doit être renvoyée. Il sera
