...
Cet événement est émis par [`xrweb`](/legacy/api/aframe/#world-tracking-image-targets-andor-lightship-vps) lorsqu'une image cible est trouvée pour la première fois.
