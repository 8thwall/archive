...
La valeur de retour est un objet `{viewport, shader}` mis à la disposition de
[`onProcessCpu`](/legacy/api/camerapipelinemodule/onprocesscpu) et
[`onUpdate`](/legacy/api/camerapipelinemodule/onupdate) en tant que :

`processGpuResult.gltexturerenderer` avec les propriétés suivantes :

| Propriété | Type                                       | Description                                                                                                                                                                                                              |
| --------- | ------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| fenêtre   | `{largeur, hauteur, décalageX, décalageY}` | La région du canevas ou de la texture de sortie dans laquelle dessiner ; elle peut être construite manuellement ou en utilisant [`XR8.GlTextureRenderer.fillTextureViewport()`](filltextureviewport.md). |
