...
Cet événement est émis par [`xrweb`](/legacy/api/aframe/#world-tracking-image-targets-andor-lightship-vps) lorsqu'une cible d'image change de position, de rotation ou d'échelle.
