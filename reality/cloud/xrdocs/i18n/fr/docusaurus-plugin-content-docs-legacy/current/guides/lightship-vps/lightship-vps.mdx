...
## Aperçu de Lightship VPS {#lightship-vps-overview}
...
\*\*Note : La localisation de VPS n'est pas encore disponible dans le [Simulateur]
...
que vous pouvez utiliser pour rechercher les sites activés par le SPV. La sélection d'un site
activé par VPS affichera le maillage 3D du site (#3) afin que vous puissiez vérifier que vous avez sélectionné le site
...
2. Les espaces de travail des plans `Pro` ou `Enterprise` auront l'option de **Créer un emplacement public** ou 
   **Créer un emplacement privé**. Les emplacements publics sont accessibles à tous les développeurs et à toutes les personnes qui utilisent
   leurs projets, tandis que les emplacements privés ne sont visibles et accessibles qu'à votre espace de travail et à
...
Vous pouvez ajouter des scans à [Public Locations](#location-types) ainsi que créer
[Test Scans](#test-scans) avec l'application Niantic Wayfarer.
...
Les questions relatives à la numérisation ou au traitement doivent être adressées à [support@nianticspatial.com](mailto://support@nianticspatial.com).
...
[support@nianticspatial.com](mailto://support@nianticspatial.com) pour plus d'informations.
...
Pour toute question ou problème lié à la création de sites VPS, ou pour vérifier le statut d'un site existant, veuillez contacter [support@nianticspatial.com](mailto://support@nianticspatial.com).
...
Pour toute question ou problème lié à la numérisation, à l'activation ou au statut de la localisation, veuillez contacter [support@nianticspatial.com](mailto://support@nianticspatial.com)
...
est traitée dans les deux heures. Les développeurs ont également la possibilité de demander 
la réactivation d'un lieu existant après avoir téléchargé 5 scans supplémentaires.
