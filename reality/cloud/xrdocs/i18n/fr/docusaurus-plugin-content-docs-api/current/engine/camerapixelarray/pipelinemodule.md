...
La valeur de retour est un objet mis à la disposition de [`onProcessCpu`](/api/engine/camerapipelinemodule/onprocesscpu) et
[`onUpdate`](/api/engine/camerapipelinemodule/onupdate) comme :
