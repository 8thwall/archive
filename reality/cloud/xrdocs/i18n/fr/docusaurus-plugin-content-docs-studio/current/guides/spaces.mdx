...
id: spaces
description: >-
  Un espace est un moyen d'organiser les entités et de procéder à une
...
## Simulation de l'espace actif en mode Live Sync
