...
Les types dans ecs.math peuvent être convertis vers et depuis les types mathématiques correspondants de three.js `THREE.Vector3`, `THREE.Quaternion`, et `THREE.Matrix4` en suivant les exemples ci-dessous.
