...
| jpgCompression：[オプション］ | `75`   | JPEG 圧縮の品質を表す 1-100 の値。 100はほとんど損失がなく、1は非常に低品質な画像である。 JPEG 圧縮の品質を表す 1-100 の値。 100はほとんど損失がなく、1は非常に低品質な画像である。 100はほとんど損失がなく、1は非常に低品質な画像である。 |
