...
| パラメータ   | タイプ                              | 説明                                                                                                                                                   |
| ------- | -------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------- |
| タイプ     | 文字列                              | FEATURE_POINT'`、`'ESTIMATED_SURFACE'`、`'DETECTED_SURFACE'`、`'UNSPECIFIED'\\`のいずれか1つ。 |
