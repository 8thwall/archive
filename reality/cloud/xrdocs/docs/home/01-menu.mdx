    ...
    <div class="hero-banner">
      <a href="/docs/migration/" class="hero-link">
        <div class="hero-content">
          ...
          <div class="hero-text">
            <h2 class="hero-title">Migration Guide</h2>
            <p class="hero-description">
              Learn more about changes to the 8th Wall business and how to prepare for open source.
            </p>
          </div>
          <div class="hero-cta">
            Learn More
      ...
      <a href="account" className="doc-card-link">
        <div className="doc-card">
          ...
          <div className="doc-card-content">
            <h3 className="doc-card-title">Account & Billing</h3>
            <p className="doc-card-description">Access documentation for managing your 8th Wall account.</p>
          </div>
        </div>
      </a>
      ...
      <a href="studio" className="doc-card-link">
        <div className="doc-card">
          ...
          <div className="doc-card-content">
            ...
            <p className="doc-card-description">Access documentation for 8th Wall's new Studio toolkit.</p>
          </div>
        </div>
      </a>
      ...
      <a href="api" className="doc-card-link">
        <div className="doc-card">
          ...
          <div className="doc-card-content">
            ...
            <p className="doc-card-description">Access documentation for 8th Wall's JavaScript API.</p>
          </div>
        </div>
      </a>
    </div>
      ...
      <div className="resources-grid">
        <a href="https://8thwall.com/forum" target="_blank" className="resource-card">
          ...
          <div className="resource-content">
            ...
            <p className="resource-description">Connect with other developers, ask questions, and share insights as you build with 8th Wall.</p>
          </div>
        </a>
