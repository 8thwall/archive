  ...
  apply(compiler) {
    compiler.hooks.compilation.tap(
      ...
      (compilation, {normalModuleFactory}) => {
        // make sure ConstDependency is known to webpack
        // (this might occur when different webpack versions exists)
            ...
            parser.hooks.importSpecifier.tap(
              ...
              (_statement, source, id, name) => {
                if (
                  ...
                  // when we do not replace the current url
                  // or the replacement is just adding a slash we navigate
