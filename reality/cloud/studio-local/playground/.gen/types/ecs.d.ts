/* eslint-disable */
// file copied from https://github.com/8thwall/prod8/pull/895
import { AmbientLight, AnimationClip, BufferGeometry, Camera as Camera$1, Color as Color$1, ColorSpace, DirectionalLight, Euler, Event as Event$1, Group, Intersection, Material as Material$1, Matrix4, Mesh, MeshStandardMaterial, Object3D as OriginalObject3D, OrthographicCamera, PerspectiveCamera, PointLight, Quaternion, Scene, SpotLight, Texture, Vector3, Vector4, WebGLRenderTarget, WebGLRenderer } from 'three';
...
type Material = BasicMaterial | UnlitMaterial | ShadowMaterial | HiderMaterial | null;
type Url = {
	type: "url";
	url: string;
};
...
type NoShadowLights = AmbientLight;
...
type CameraConfig = ReturnType<typeof Camera$2.get>;
...
interface LateWorld {
	...
	destroy: () => void;
	loadScene: (scene: DeepReadonly<SceneGraph>) => SceneHandle;
	createEntity: () => Eid;
	deleteEntity: (eid: Eid) => void;
	spawnIntoObject: (eid: Eid, object: DeepReadonly<GraphObject>, graphIdToEid: Map<string, Eid>) => void;
	...
	input: InputApi;
	xr: XrManager;
	setSpaceHook: (hook: SpacesHandle) => void;
	spaces: SpacesHandle;
}
...
type StateId = string | StateDefiner;
declare class StateDefiner {
	readonly name: string;
	isInitial: boolean;
	onEnterImpl?: State["onEnter"] | undefined;
	onTickImpl?: State["onTick"] | undefined;
	onExitImpl?: State["onExit"] | undefined;
	triggers: State["triggers"];
	eventListeners: NonNullable<State["listeners"]>;
...
export interface StateGroup {
	substates?: StateId[];
	triggers: Record<string, Trigger[]>;
	onEnter?: (enteredState: string) => void;
	onTick?: (currentState: string) => void;
	onExit?: (exitedState: string) => void;
	listeners?: ListenerParams[];
}
declare class StateGroupDefiner {
	substates?: StateGroup["substates"];
	triggers: StateGroup["triggers"];
	onEnterImpl?: StateGroup["onEnter"] | undefined;
	onTickImpl?: StateGroup["onTick"] | undefined;
	onExitImpl?: StateGroup["onExit"] | undefined;
	eventListeners: NonNullable<StateGroup["listeners"]>;
	constructor(substates?: StateGroup["substates"]);
	/**
	 * generate the group object for definer
	 * @returns the stater group object
	 */
	generateStateGroup(): StateGroup;
	/**
...
type GenerateStateDefiner = (name: string) => StateDefiner;
/**
 * Function to define a new state
 * @param name the name of the state
 * @returns a new state
 */
export declare const defineState: GenerateStateDefiner;
/**
 * Function to define a new group
 * @param substates the substates of the group (leaving blank will capture all states)
 * @returns a new group
 */
export declare const defineStateGroup: (substates?: Array<StateId | StateGroupDefiner>) => StateGroupDefiner;
/**
 ...
 */
export declare const createStateMachine: (world: World, eid: Eid, definition: StateMachineDefinition | StateMachineDefiner) => MachineId;
...
type ComponentRegistration<S extends Schema, D extends Schema> = {
	name: string;
	schema?: S;
	schemaDefaults?: Partial<ReadData<S>>;
	data?: D;
	add?: (w: World, cursor: ComponentCursor<S, D>) => void;
	tick?: (w: World, cursor: ComponentCursor<S, D>) => void;
	remove?: (w: World, cursor: ComponentCursor<S, D>) => void;
	stateMachine?: StateMachineDefinition | ComponentStateMachineDefiner<S, D>;
};
export declare const registerComponent: <S extends Schema, D extends Schema>({ name, schema, schemaDefaults, stateMachine: machineDef, data, tick, add, remove, }: ComponentRegistration<S, D>) => RootAttribute<S>;
...
export declare const PositionAnimation: RootAttribute<{
	autoFrom: "boolean";
	fromX: "f32";
	fromY: "f32";
	fromZ: "f32";
...
export declare const ScaleAnimation: RootAttribute<{
	autoFrom: "boolean";
	fromX: "f32";
	fromY: "f32";
	fromZ: "f32";
...
export declare const RotateAnimation: RootAttribute<{
	autoFrom: "boolean";
	fromX: "f32";
	fromY: "f32";
	fromZ: "f32";
...
export declare const CustomVec3Animation: RootAttribute<{
	attribute: "string";
	autoFrom: "boolean";
	fromX: "f32";
	fromY: "f32";
...
export declare const CustomPropertyAnimation: RootAttribute<{
	attribute: "string";
	property: "string";
	autoFrom: "boolean";
	from: "f32";
...
export declare const FollowAnimation: RootAttribute<{
	target: "eid";
	minDistance: "f32";
	maxDistance: "f32";
	elasticity: "f32";
}>;
export declare const LookAtAnimation: RootAttribute<{
	target: "eid";
	targetX: "f32";
	targetY: "f32";
	targetZ: "f32";
...
export declare const ParticleEmitter: RootAttribute<{
	stopped: "boolean";
	emitterLife: "f32";
...
export declare const OrbitControls: RootAttribute<{
	speed: "f32";
	maxAngularSpeed: "f32";
	maxZoomSpeed: "f32";
	distanceMin: "f32";
...
export declare const FlyController: RootAttribute<{
	verticalSensitivity: "f32";
	horizontalSensitivity: "f32";
	moveSpeedX: "f32";
	moveSpeedY: "f32";
...
export declare const FaceAnchor: RootAttribute<Schema>;
export declare const FaceMeshAnchor: RootAttribute<Schema>;
export declare const FaceAttachment: RootAttribute<{
	point: "string";
}>;
export declare const LocationAnchor: RootAttribute<Schema>;
