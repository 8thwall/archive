...
const getStripeLocaleMap = () => filterUnsupported8w({
  'en-US': 'en',
  'ja-JP': 'ja',
  'fr-FR': 'fr',
  'de-DE': 'de',
  'es-MX': 'es-419',
} as {[key in SupportedLocale8w]: StripeElementLocale})

type HubSpotLocale = 'en-us' | 'ja' | 'fr' | 'de' | 'es'
const getHubSpotLocaleMap = () => filterUnsupported8w({
  'en-US': 'en-us',
  'ja-JP': 'ja',
  'fr-FR': 'fr',
  'de-DE': 'de',
  'es-MX': 'es',
} as {[key in SupportedLocale8w]: HubSpotLocale})
