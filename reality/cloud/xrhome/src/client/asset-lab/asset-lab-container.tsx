...
import {AssetLabDownloadAssetsButton} from './asset-lab-download-assets-button'
      ...
      <div className={combine(classes.assetLabContainer, extraClass)}>
          ...
          <div>
            <IconButton
              ...
              onClick={() => {
                ...
                if (!isModal) {
                  history.push(getPathForAccount(account, AccountPathEnum.workspace))
                }
              }}
        ...
        {mode !== 'detailView' && mode !== 'optimizer' && (
          <div className={classes.modeBar}>
            ...
            <SpaceBetween direction='horizontal' centered>
              {BuildIf.ASSET_LAB_DOWNLOAD_ASSETS_20251201 && <AssetLabDownloadAssetsButton />}
