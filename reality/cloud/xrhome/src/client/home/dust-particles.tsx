...
const PARTICLE_COLORS: {color: string, frequency: number}[] = [
  {color: hexColorWithAlpha(white, 0.7), frequency: 5},
  {color: hexColorWithAlpha(mango, 0.6), frequency: 3},
  {color: hexColorWithAlpha(white, 0.4), frequency: 3},
  {color: white, frequency: 2},
  {color: hexColorWithAlpha(mango, 0.2), frequency: 1},
]
...
const useBokehStyles = createCustomUseStyles<IBokehStyles>()({
  ...
  'particle': {
    ...
    boxShadow: props => `0 0 7px 2px ${props.color}`,
    position: 'absolute',
...
const DustParticles: React.FC<IBokehBackground> = React.memo(
