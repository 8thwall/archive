...
const ExportFlowIframe: React.FC = () => {
  ...
  const hasProductionDeployment = useCurrentGit(git => git?.deployment.production)
  const productionUrl = makeHostedProductionUrl(account.shortName, app.appName)
      ...
      <div className={classes.rightCol}>
        ...
        <CopyableCodeBlock
          code={embedType === 'iframe'
            ...
            : getFullHtmlCode(app.appTitle || app.appName,
              productionUrl, IFRAME_AVAILABLE_PERMISSIONS)
            }
          disabled={!hasProductionDeployment}
          tooltip={
              !hasProductionDeployment && t('editor_page.publish_modal.iframe.disabled_tooltip')
            }
