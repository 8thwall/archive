...
import type AceEditor from '../../third_party/react-ace/ace'
...
// NOTE(pawel) This function is unused but it's needed in order to get the correct type for the ref.
const UseAceEditorRef = () => useRef<AceEditor>()
type AceEditorRef = ReturnType<typeof UseAceEditorRef>
