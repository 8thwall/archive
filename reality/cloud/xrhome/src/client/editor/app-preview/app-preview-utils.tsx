...
const APP_PREVIEW_PANE_MIN_SIZE = 250
...
type LocationOptionData = SequenceOptionData & {
  poiId: string
}
...
const makeLocationOption = (
  {name, section, rightContent, poiId}: LocationOptionData
): DropdownOption => ({
  value: poiId,
  content: (
    <DropdownOptionContent
