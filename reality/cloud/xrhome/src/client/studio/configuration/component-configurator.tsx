...
import {GpsPointerConfigurator} from './gps-pointer-configurator'
...
const CUSTOM_COMPONENT_CONFIG = new Set(['face-attachment', 'gps-pointer'])
...
const ComponentConfigurators: React.FC<IComponentConfigurators> = ({
  object, components, onChange, resetToPrefab, applyOverridesToPrefab,
}) => {
            ...
            >
              ...
              {name === 'gps-pointer' &&
                <GpsPointerConfigurator
                  object={object}
                  values={component.parameters as any}
                  onChange={callback => onChange((current) => {
                    ...
                    return {
                      ...
                      [component.id]: {
                        ...currentComponent,
                        parameters: callback(currentComponent.parameters as any),
                      },
                    }
                  })}
                />
