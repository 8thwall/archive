...
import {LocationConfigurator} from './location-configurator'
...
const MapConfigurator = React.lazy(() => import('./map-configurator'))
const MapPointConfigurator = React.lazy(() => import('./map-point-configurator'))
  ...
  return (
    <ScenePathRootProvider path={['objects', object.id]}>
      ...
      >
        ...
        {object.mapPoint &&
          <React.Suspense fallback={null}>
            <MapPointConfigurator
              id={object.id}
              point={object.mapPoint}
            />
          </React.Suspense>
      }
