          ...
          <RowGroupFields label={t('ui_configurator.ui_corner_radius.label')}>
            <div className={classes.columnContainer}>
              <NumberOrPercentInput
                ...
                ariaLabel={t('ui_configurator.ui_corner_radius.option.top_left.label')}
              ...
              <NumberOrPercentInput
                ...
                ariaLabel={t('ui_configurator.ui_corner_radius.option.bottom_left.label')}
            ...
            <div className={classes.columnContainer}>
              <NumberOrPercentInput
                ...
                ariaLabel={t('ui_configurator.ui_corner_radius.option.top_right.label')}
              ...
              <NumberOrPercentInput
                ...
                ariaLabel={t('ui_configurator.ui_corner_radius.option.bottom_right.label')}
