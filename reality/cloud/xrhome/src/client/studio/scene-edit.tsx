...
const SceneEdit: React.FC<ISceneEdit> = ({
  ...
  sourceControlConfigurator, simulatorPanel, codeEditorSettings,
  fixedHelpButtonTray, mapPanel, mapToggle, playbackControls, renderScenePlayback,
  hideViewport,
}) => {
  ...
  const gsbStateCtx = useGsbStateContext()
                    ...
                    <div className={classes.paneContainer}>
                      ...
                      <div className={classes.centerUiContainer}>
                        ...
                        <React.Suspense fallback={null}>
                          {gsbStateCtx.state?.open && mapPanel}
                        </React.Suspense>
                        <React.Suspense fallback={null}>
