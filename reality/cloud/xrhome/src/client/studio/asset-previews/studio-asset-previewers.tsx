      ...
      <div className={classes.controls}>
        <div className={appPreviewStyles.actionButton}>
          <IconButton
            ...
            text={isPlaying
              ? t('asset_configurator.studio_asset_preview.playable_media.pause_label')
              : t('asset_configurator.studio_asset_preview.playable_media.play_label')
            }
          />
        </div>
        <div
            ...
            {audioState.hasAudio &&
              <div className={appPreviewStyles.actionButton}>
                <IconButton
                  ...
                  text={isMuted
                    ? t('asset_configurator.studio_asset_preview.video_sound.unmute_label')
                    : t('asset_configurator.studio_asset_preview.video_sound.mute_label')}
                />
              </div>
            }
            <div className={appPreviewStyles.actionButton}>
              <IconButton
                ...
                text={t('asset_configurator.studio_asset_preview.video_fullscreen.button_label')}
              />
            </div>
          </>
        }
