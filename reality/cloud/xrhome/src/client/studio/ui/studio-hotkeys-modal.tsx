...
import {
  ...
  getShortcutBindings, MACOS_SHORTCUTS_INDEX, WINDOWS_SHORTCUTS_INDEX,
...
const StudioHotkeysModal: React.FC<IStudioHotkeysModal> = ({
  ...
  const hasCodeEditorBindings = keyboardHandler === 'ace' || keyboardHandler === 'vscode'
  const bindings = getShortcutBindings(app)
  const categories = hasCodeEditorBindings ? bindings[keyboardHandler] : CLOUD_STUDIO_SHORTCUTS
