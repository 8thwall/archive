const animateFaceComponent = {
  init() {
    ...
    document.getElementById('midFaceLeft').addEventListener('model-loaded', () => {
      faceGltf2 = document.getElementById('midFaceLeft').getObject3D('mesh')
      let materialReplaced = false
      faceGltf2.traverse((node) => {
        if (!materialReplaced || node.material) {
          node.material = materialGltf
          materialReplaced = true
        }
    ...
    document.getElementById('midFaceLeft2').addEventListener('model-loaded', () => {
      faceGltf3 = document.getElementById('midFaceLeft2').getObject3D('mesh')
      let materialReplaced = false
      faceGltf3.traverse((node) => {
        if (!materialReplaced || node.material) {
          node.material = materialGltf
          materialReplaced = true
        }
    ...
    document.getElementById('midFaceRight2').addEventListener('model-loaded', () => {
      faceGltf4 = document.getElementById('midFaceRight2').getObject3D('mesh')
      let materialReplaced = false
      faceGltf4.traverse((node) => {
        if (!materialReplaced || node.material) {
          node.material = materialGltf
          materialReplaced = true
        }
    ...
    const show = (event) => {
      ...
      faceGltf2.children[0].geometry.setAttribute('position', new THREE.BufferAttribute(vertices, 3))
      faceGltf2.children[0].geometry.attributes.position.needsUpdate = true

      faceGltf3.children[0].geometry.setAttribute('position', new THREE.BufferAttribute(vertices, 3))
      faceGltf3.children[0].geometry.attributes.position.needsUpdate = true

      faceGltf4.children[0].geometry.setAttribute('position', new THREE.BufferAttribute(vertices, 3))
      faceGltf4.children[0].geometry.attributes.position.needsUpdate = true
      ...
      faceGltf2.children[0].geometry.setAttribute('uv', new THREE.BufferAttribute(uvs, 2))
      faceGltf3.children[0].geometry.setAttribute('uv', new THREE.BufferAttribute(uvs, 2))
      faceGltf4.children[0].geometry.setAttribute('uv', new THREE.BufferAttribute(uvs, 2))
      ...
      faceGltf2.children[0].geometry.attributes.normal.needsUpdate = true
      faceGltf3.children[0].geometry.attributes.normal.needsUpdate = true
      faceGltf4.children[0].geometry.attributes.normal.needsUpdate = true
    }
