...
In **head.html**, we add `<meta name="8thwall:package" content="@mrcs.holovideoobject:1.3.7">` (or `<script>https://cdn.8thwall.com/web/mrcs/holovideoobject-1.3.7.min.js</script>` for self-hosted) and
