...
//     this.intersections = new Map()  // To track intersections and ensure no duplicates
...
//           // Ensure the intersected object is the model, not the voxels
//           if (intersectedObject && intersectedObject !== this.el) {
...
//               y: Math.round(localIntersectPoint.y / voxelSize) * voxelSize,
...
//               voxel.setAttribute('material', 'shader: flat; side: double')
