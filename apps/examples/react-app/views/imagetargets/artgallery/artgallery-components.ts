const ArtgalleryFrameComponent = {
  ...
  init() {
    ...
    const infoDisplay : any = document.createElement('a-entity')
    ...
    fetch(apiUrl, {mode: 'cors'})
      .then(e => e.json())
      .then((data) => {
        const page : any = Object.entries(data.query.pages)[0][1]
...
const InfoDisplayComponent = {
  ...
  init() {
    ...
    const textShadowEl : any = document.createElement('a-entity')
...
const ArtgalleryFramePrimitive = {
  defaultComponents: {
    artgalleryframe: {},
  },
...
const ArtGalleryPrimitives = [
  {name: 'artgallery-frame', val: ArtgalleryFramePrimitive},
]

export {ArtGalleryComponents, ArtGalleryPrimitives}
