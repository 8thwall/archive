...
A-Frame integration of Scatter's [Depthkit](https://www.depthkit.tv/) using 8th Wall.

![](https://media.giphy.com/media/W0c2GSYYUEK1NUeDNy/giphy.gif)
...
4. Reference your assets in the *capture* parameter from within the *depthkit* component. 
This assumes your .txt and .mp4 share the same name (i.e. autumn in this example).

![](https://miro.medium.com/max/1280/1*_Cs94kHQpC_lgU4h_rU9ew.gif)
...
(NOTE: In this project `depthkit` in `components.js` is [`this.character`](https://www.8thwall.com/playground/depthkit-aframe/master/components.js#L67))
