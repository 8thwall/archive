...
Get started with 8th Wall Hand Tracking! This three.js example attaches an orb, watch, and ring to the hand, creates a purple hand mesh,
...
`hand-scene.js` generates the hand mesh, sets its material, and updates its transforms. It imports a ring and watch model and attaches them to the appropriate attachment points on the hand.
It also adds a hand occluder, rotates the watch based on handKind, and adds realtime reflections for the 3D models.
