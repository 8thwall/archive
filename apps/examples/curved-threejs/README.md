# three.js: Curved Image Targets

This three.js example project showcases video playback on a cylindrical wine label.
...
out the target. There's even a ruler (mm) to help you measure circumference with ease!
