...
1. Add a test scan or public Location to the project via the Geospatial Browser (https://www.8thwall.com/docs/web/#managing-wayspots)
2. Copy the 'name' of the test scan or the public Location and replace `my-location` with the name of the project Location on line 28 of `body.html` (the `named-location` `name` parameter)
