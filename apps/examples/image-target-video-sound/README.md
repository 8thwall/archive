# A-Frame: Image Target Video Sound
...
```xrextras-target-video-sound``` displays a thumbnail image and waits for user tap to begin playback (for videos with sound).

- video: the id of the <video> element
- thumb: the id of the <img> element to serve as a thumbnail (optional)
- height: scale the generated geometry heigh by the value (default: 1)
...
Check out the Live Learning session on Developing WebAR with Video Textures [here](https://www.youtube.com/watch?v=BMVmxy9UtFo&t=1102s).
