...
import {skySlamScenePipelineModule} from './sky-slam-scene-pipeline-module'
...
const onxrloaded = () => {
  XR8.addCameraPipelineModules([  // Add camera pipeline modules.
    ...
    // Custom pipeline module to add virtual content to the sky and slam scenes.
    skySlamScenePipelineModule(),
  ])
