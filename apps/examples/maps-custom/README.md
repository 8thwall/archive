...
* components/
  ...
  * **detect-mesh.js** uses `xrmeshfound` and `xrmeshupdated` events to localize against any nearby VPS Activated Wayspot
* scenes/
...
There are three procedural-related events:
...
- [xrmeshupdated](https://www.8thwall.com/docs/web/#xrmeshupdated): emitted when the first mesh found changes position or rotation.
