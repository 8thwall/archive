...
const customWayspotComponent = {
  schema: {
    ...
    anyWayspotColor: {type: 'string', default: '#ffc894'},
  },
  init() {
    ...
    // each instance listens for the event to change colors or objects
...
export {
  ...
  customWayspotPrimitive, mapLoadingScreenComponent, mapDebugControlsComponent,
}
