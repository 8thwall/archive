// Source: https://github.com/ocornut/imgui/tree/1ad1429c6df657f9694b619d53fa0e65e482f32b
// NOTE(paris): When updating, find the lines like `static bool show_app_main_menu_bar = false` and
// set them to true. dear imgui, v1.84 WIP (demo code)
...
void ImGui::ShowDemoWindow(bool *p_open) {
  ...
  if (show_app_dockspace)
    ShowExampleAppDockSpace(
      &show_app_dockspace);  // Process the Docking app first, as explicit DockSpace() nodes needs
  ...
  if (ImGui::CollapsingHeader("Configuration")) {
    ...
    if (ImGui::TreeNode("Configuration##2")) {
      ...
      if (io.ConfigFlags & ImGuiConfigFlags_DockingEnable) {
        ...
        ImGui::SameLine();
        HelpMarker(
          "Make window or viewport transparent when docking and only display docking boxes on the "
      ...
      if (io.ConfigFlags & ImGuiConfigFlags_ViewportsEnable) {
        ...
        ImGui::SameLine();
        HelpMarker(
          "Toggling this at runtime is normally unsupported (most platform backends won't refresh "
...
static void ShowDemoWindowWidgets() {
  ...
  if (ImGui::TreeNode("Combo")) {
    ...
    const char *combo_label = items[item_current_idx];  // Label to preview before opening the combo
  ...
  if (ImGui::TreeNode("Text Input")) {
    ...
    if (ImGui::TreeNode("Completion, History, Edit Callbacks")) {
      ...
      ImGui::SameLine();
      HelpMarker(
        "Here we replace and select text each time Up/Down are pressed. See 'Examples>Console' for "
  ...
  if (ImGui::TreeNode("Tabs")) {
    ...
    if (ImGui::TreeNode("TabItemButton & Leading/Trailing flags")) {
      ...
      if (ImGui::BeginTabBar("MyTabBar", tab_bar_flags)) {
        ...
        // because of the ImGuiTabItemFlags_Trailing flag it will always appear at the end.
  ...
  if (ImGui::TreeNode("Drag/Slider Flags")) {
    ...
    ImGui::SameLine();
    HelpMarker(
      "Disable rounding underlying value to match precision of the format string (e.g. %.3f values "
...
// hence the /2.
  ...
  if (ImGui::TreeNode("Querying Status (Edited/Active/Focused/Hovered etc.)")) {
    ...
    ImGui::SameLine();
    HelpMarker(
      "Testing how various types of items are interacting with the IsItemXXX functions. Note that "
...
static void ShowDemoWindowLayout() {
  ...
  if (ImGui::TreeNode("Child windows")) {
    ...
    // Child 1: no border, enable horizontal scrollbar
    {
      ...
      ImGui::BeginChild(
        "ChildL", ImVec2(ImGui::GetWindowContentRegionWidth() * 0.5f, 260), false, window_flags);
...
static void ShowDemoWindowTables() {
  ...
  if (ImGui::TreeNode("Basic")) {
    ...
    HelpMarker(
      ...
      "This is also more similar to the old NextColumn() function of the Columns API, and provided "
      "to facilitate the Columns->Tables API transition.");
  ...
  if (ImGui::TreeNode("Padding")) {
    ...
    HelpMarker(
      ...
      "Because of this, activating BorderOuterV sets the default to PadOuterX. Using PadOuterX or "
      "NoPadOuterX you can override the default.\n\n"
  ...
  if (ImGui::TreeNode("Sizing policies")) {
    ...
    ImGui::SameLine();
    HelpMarker(
      "This section allows you to interact and see the effect of various sizing policies depending "
      "on whether Scroll is enabled and the contents of your columns.");
  ...
  if (ImGui::TreeNode("Columns flags")) {
    ...
    // using ImGuiTableFlags_NoKeepColumnsVisible + resizing the parent window down)
  ...
  if (ImGui::TreeNode("Row height")) {
    HelpMarker(
      ...
      "'style.CellPadding.y' on top and bottom, so effectively the minimum row height will always "
  ...
  if (ImGui::TreeNode("Context menus")) {
    ...
    HelpMarker(
      "Demonstrate mixing table context menu (over header), item context button (over button) and "
...
struct ExampleAppConsole {
  ...
  void Draw(const char *title, bool *p_open) {
    ...
    // of items that passed the filtering test, recomputing this array when user changes the filter,
    // and appending newly elements as they are inserted. This is left as a task to the user until
    // we can manage to improve this example code! If your items are of variable height:
...
static void ShowExampleAppCustomRendering(bool *p_open) {
  ...
  if (ImGui::BeginTabBar("##TabBar")) {
    ...
    if (ImGui::BeginTabItem("Canvas")) {
      ...
      //      background color ImGui::BeginChild("canvas", ImVec2(0.0f, 0.0f), true,
      ...
      if (
        opt_enable_context_menu && ImGui::IsMouseReleased(ImGuiMouseButton_Right)
...
void ShowExampleAppDockSpace(bool *p_open) {
  // In 99% case you should be able to just call DockSpaceOverViewport() and ignore all the code
  ...
  // DockSpaceOverViewport() in your code!) TL;DR; this demo is more complicated than what you would
  // normally use. If we removed all the options we are showcasing, this demo would become:
  ...
  if (ImGui::BeginMenuBar()) {
    ...
    HelpMarker(
      ...
      "create a docking node _within_ another window. This is useful so you can decorate your main "
      "application window (e.g. with a menu bar)."
      "\n\n"
      "ImGui::DockSpace() comes with one hard constraint: it needs to be submitted _before_ any "
      "window which may be docked into it. Therefore, if you use a dock spot as the central point "
      "of your application, you'll probably want it to be part of the very first window you are "
      "submitting to imgui every frame."
      "\n\n"
      "(NB: because of this constraint, the implicit \"Debug\" window can not be docked into an "
      "explicit DockSpace() node, because that window is submitted as part of the NewFrame() call. "
      "An easy workaround is that you can create your own implicit \"Debug##2\" window after "
      "calling DockSpace() and leave it in the window stack for anyone to use.)");
