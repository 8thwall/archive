...
void FaceGlobalView::configure(const AppConfiguration &appConfig) {
...
void FaceGlobalView::initialize(std::unique_ptr<OmniscopeViewData> &dataPtr) {
...
void FaceGlobalView::processCpu(OmniscopeViewData *data) {
...
void FaceGlobalView::updateScene(OmniscopeViewData *data) {
  auto &renderData = data->cpuProcessingResult<RenderData>();
...
void FaceGlobalView::resetScene() {
  // noop
}

void FaceGlobalView::renderDisplay(OmniscopeViewData *data) {
...
void FaceGlobalView::gotTouches(const Vector<Touch> &touches) {
  if (touches.size() == 2) {
    resetScene();
    return;
  }
...
void FaceGlobalView::initializeScene(OmniscopeViewData *data) {
...
bool FaceGlobalView::updateSceneWithUserInput() {
