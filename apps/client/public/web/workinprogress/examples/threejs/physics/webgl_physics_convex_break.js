// Based on https://github.com/mrdoob/three.js/blob/master/examples/webgl_physics_convex_break.html
// Modified to run within 8th Wall Web

const physicsScenePipelineModule = () => {
  ...
  var tapCoords = new THREE.Vector2();
  ...
  function removeDebris( object ) {
    const {scene} = XR.Threejs.xrScene()
    scene.remove( object );
