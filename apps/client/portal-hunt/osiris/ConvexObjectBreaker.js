...
THREE.ConvexObjectBreaker.prototype = {
  ...
  getGeometry: function(object) {
    var geometry = object.geometry ||
                   object.children.length && object.children[0].geometry ||
                   object.getObjectByProperty('isMesh', true).geometry

    if (!geometry || !geometry.attributes || !geometry.attributes.position) {
      console.log('no geometry/position on', object)
      return
    }
    return geometry
  },
  ...
  prepareBreakableObject: function ( object, mass, velocity, angularVelocity, breakable ) {
    ...
    var geometry = this.getGeometry(object);
